        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-validation">
                    <form action="{{route('phase.update', $edit_phase->id)}}" method="POST" class="needs-validation" novalidate="">
                        @csrf
                        @method('PUT')
                        <div class="row card">
                            <div class="card-header">
                                <h4 class="card-title">Edit Phase Info</h4>
                            </div>
                            ...
                            <div class="col-md-12 pt-2">
                                ...
                                <div class="mb-3 row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-lg-12">
                                            <input type="text" class="form-control" id="stallNo" name="stall_no"  value="{{  $edit_phase->stall_no ?? old('stall_no') }}" placeholder="Enter a stall number.." required="">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-lg-12">
                                            <select name="cat_id" id="selectCatName" class="form-control">
                                                ...
                                                <option {{($edit_phase->section_id == $data->id)? 'selected' : ''}} value="{{$data->id}}">{{$data->section_name}}</option>
                                                @endforeach
                                            </select>
                                            @error('cat_id')
                                                <small class="text-danger" role="alert">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea name="description" class="form-control" id="description" cols="30" rows="5" placeholder="Enter a stall description.."  required="">{{  $edit_phase->description ?? old('description') }}</textarea>
                                        <div class="invalid-feedback">
